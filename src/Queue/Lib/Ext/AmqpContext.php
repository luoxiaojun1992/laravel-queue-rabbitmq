...
class AmqpContext extends \Enqueue\AmqpExt\AmqpContext implements InteropAmqpContext, DelayStrategyAware
{
    ...
    public function convertMessage(\AMQPEnvelope $extEnvelope): InteropAmqpMessage
    {
        ...
        $message->setExchangeName($extEnvelope->getExchangeName());
