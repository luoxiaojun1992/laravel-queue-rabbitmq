...
namespace VladimirYuldashev\LaravelQueueRabbitMQ\Queue\Lib\Amqp;
...
class AmqpContext extends \Enqueue\AmqpLib\AmqpContext implements InteropAmqpContext, DelayStrategyAware
{
    ...
    public function convertMessage(LibAMQPMessage $amqpMessage): InteropAmqpMessage
    {
        ...
        $message->setExchangeName($amqpMessage->delivery_info['exchange'] ?? '');
